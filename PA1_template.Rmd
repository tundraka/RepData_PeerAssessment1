...
entries with `NA` steps. I am making the dates as characters so they are
displayed correctly in the table below. 
...
```{r weekdaysplot}
weekDay <- imputed[,.(total=sum(steps)), .(interval, weekday)]
